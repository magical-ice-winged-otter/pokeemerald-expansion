...
#define USE_BARD_PHONEMES            TRUE    // If FALSE, save space by using the default sound instead of unique bard phonemes. May break code that relies on `bard_music.c`, such as the Mauville man NPC.
